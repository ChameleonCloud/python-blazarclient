...
class BlazarShell(app.App):
    ...
    def build_option_parser(self, description, version, argparse_kwargs=None):
        ...
        parser.add_argument(
            "--version", action="version", version=base_version.__version__
        )
        parser.add_argument(
            "-v",
            "--verbose",
        ...
        parser.add_argument(
            ...
            default=env(
                "OS_RESERVATION_API_VERSION", default=DEFAULT_API_VERSION
            ),
            help="Accepts 1 now, defaults to 1.",
        )
        parser.add_argument(
            "--os_reservation_api_version", help=argparse.SUPPRESS
        )
        ...
        parser.add_argument(
            ...
            help=(
                "(deprecated) use --os-service-type instead. "
        ...
        parser.add_argument(
            ...
            help=(
                "(deprecated) use --os-interface intstead. "
